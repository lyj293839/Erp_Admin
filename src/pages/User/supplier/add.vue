            ...
            <el-card class="box-card basis" style="width: 100%;">
                ...
                <div class="item1">
                    ...
                    <div class="d2-m-10" style="width: 130px;">
                        ...
                        <el-select v-model="basis.country_code" size="mini" placeholder="Please Select">
                            <el-option
                    ...
                    <div v-if="personal" class="d2-m-10" style="width: 130px;">
                        ...
                        <!--<el-select v-model="basis.pid"  size="mini" filterable clearable-->
                                   <!--placeholder="Please Select">-->
                            <!--<el-option-->
                                    <!--v-for="(item,index) in parent_company"-->
                                    <!--:key="index"-->
                                    <!--:label="item.name"-->
                                    <!--:value="item.id">-->
                            <!--</el-option>-->
            ...
            <el-card class="box-card exemption" style="width: 100%;">
                ...
                <div v-for="item in exemption_amount"
                    ...
                    <div class="item1">
                        ...
                        <div class="d2-m-10" style="width: 140px;">
                            <p><span style="color:red;">*</span>{{$t('user.supplier.exemption.currency_id')}}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                lists(this.queryList, 'supplier/add').then(res => {
