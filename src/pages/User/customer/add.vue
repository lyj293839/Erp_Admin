...
<template>
    <d2-container>
            ...
            <el-card class="box-card basis" style="width: 100%;">
                ...
                <div class="item1">
                    ...
                    <div class="d2-m-10" style="width: 130px;">
                        ...
                        <el-select v-model="basis.country_code" filterable size="mini" @change="country_change(basis.country_code)"
            ...
            <el-card class="box-card contracts" style="width: 100%;">
                ...
                <div v-for="(item,index) in contracts"
                    ...
                    <div class="item1">
                        ...
                        <!-- <div class="d2-m-10" style="width: 140px;">
                            <p><span style="color:red;">*</span>{{$t('user.customer.contracts.user_type')}}</p>
            ...
            <el-card class="box-card receive" style="width: 100%;">
                ...
                <div v-for="(item,index) in receive_address"
                     style="box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04);padding: 10px;margin: 10px 0;">
                    <div class="item1">
                        <div class="d2-m-10" style="width: 140px;">
    ...
    export default {
        ...
        methods: {
            ...
            supplyMethod(query) {
                if (query !== "") {
                    setTimeout(() => {
                        member_company(query,'1',this.member_id).then(res => {
            ...
            fetchData() {
                lists(this.queryList, 'customer/add').then(res => {
                    if (res && res.code == 0) {
                        ...
                        this.basis.sort=1
                        // this.basis.custmoer_type=3
                        this.payment_day_info=this.payment_day_info_[3]
            ...
            delete_receive(item, index) {
                if (item.id) {
                    destroy(item, 'customer', 'receive_address_destory', this)
                } else {
                    this.receive_address.splice(index, 1)
                }
            },
