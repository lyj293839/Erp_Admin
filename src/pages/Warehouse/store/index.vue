...
<template>
  <d2-container>
    <el-row>
      <!--树形结构 开始-->
      <el-col :span="8">
        <el-button type="primary" @click="add_First" size="mini" style="margin:10px;">{{$t('add')}}</el-button>
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
              ...
              <span>
                <el-button
                  ...
                  style="margin-left: 5px;padding: 7px 0;"
                >
        ...
        <div class="grid-content">
          <el-card v-if="dialogFirst" class="box-card">
            <el-form :model="first_unit" label-width="130px" class="demo-ruleForm">
              <el-form-item :label="$t('wareHouse.unit.unit1')">
                <el-select
                ...
                >
                  <el-option v-for="(i,index) in type" :label="i" :value="i"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item :label="$t('wareHouse.unit.unit2')">
          ...
          <el-card v-if="dialogSecond" class="box-card">
            <el-form :model="second_unit" label-width="130px" class="demo-ruleForm">
              ...
              <el-form-item :label="$t('wareHouse.unit.unit3')">
                <el-input v-model="second_unit.name" autocomplete="off" size="small"></el-input>
              </el-form-item>
              <el-form-item :label="$t('wareHouse.unit.unit4')">
