        ...
        methods: {
            ...
            handleSelect_corporation(item) {
                ...
                item.storage_cond.forEach(i=>{
                    arr.push(this.getEnumValue(this.StorageCondition,i,'name_en'))
                })
                this.prod_list_aq.testitem.forEach(i=>{
                    if(i.testitem=='Appearance'){
                     i.Results = item.chemprodappearance_id?this.GEnums.ChemicalAppearance[item.chemprodappearance_id].name_en:i.Results
                    }
