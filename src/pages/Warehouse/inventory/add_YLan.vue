...
<template>
    <div>
        <div>
            ...
            <div
                style="border-bottom:1px solid black;padding-bottom:10px;display:flex;justify-content: space-between;align-items: center;"
            >
                <!-- <div>
                ...
                <div style="width:200px;">
                    <img src="../../../../public/image/theme/d2/logo/logo200.png" style="width:100%;" />
                </div>
            </div> 
