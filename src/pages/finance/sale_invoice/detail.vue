    ...
    <div class="div">
      ...
      <el-form label-width="0px" label-position="right">
        ...
        <div style="margin:20px 0px;">
          ...
          <el-form-item v-show="form_show3" class="from-item">
            <table border="1" bordercolor="#E5E5E5" v-for="item in detail_.invoices" :key="item.id">
              ...
              <tr v-for="(item_a,index) in item.invoice_details" :key="index">
        ...
        <div style="margin:20px 0px;">
          ...
          <el-form-item v-show="form_show2" class="from-item">
            <table border="1" bordercolor="#E5E5E5">
              ...
              <tr v-for="(item,index) in detail_.details" :key="index">
          ...
          <el-form-item v-show="form_show4" class="from-item">
            <table border="1" bordercolor="#E5E5E5">
              ...
              <tr>
                ...
                <td>
                  {{detail.tax}}
                  <!-- <el-select size="mini" v-model="detail.tax">
        ...
        <el-form-item class="from-item" style="margin:0px;text-align: center">
          <el-button type="primary" @click="save()" size="small" :loading="save_fy">保存</el-button>
        </el-form-item>
      </el-form>
    </div>
  </d2-container>
...
import $ from "jquery";
import { notice_billing_view, notice_billing,rollback_invoice } from "@/api/finance";
...
export default {
  ...
  methods: {
    ...
    fetchData(id) {
      notice_billing_view(id).then(res => {
        if (res && res.code == 0) {
          this.total_money = 0
          this.tax_money = 0
    ...
    close(){
      ...
      const tagName = "finance-sale_invoice_detail";
