...
<d2-container>
    <el-form ref="form" :model="form" label-width="90px">
        <el-row :gutter="20">
            ...
            <el-col :span="18" v-if="permission_names['finance_sales_invoice.import_sales_list_nb']=='finance_sales_invoice.import_sales_list_nb'">
...
<script>
    ...
    import {import_sales_list_nb} from '@/api/finance'
    ...
    export default {
        ...
        data() {
            return {
                ...
                upload_api: process.env.VUE_APP_API + 'api/v1/finance/sales_invoice/upload_sales_nb',
                fileList: [],
                list: {},
                loading:false
            }
        ...
        methods: {
            ...
            fetchData() {
                import_sales_list_nb(this.queryList).then(res => {
                    if(this.loading){
            ...
            black(){
                ...
                const tagName = "finance-doimport_internal";
