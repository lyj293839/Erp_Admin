  ...
  <d2-container>
    ...
    <el-card class="box-card basis" style="width: 100%;">
      ...
      <div class="item1">
        ...
        <div class="d2-m-10" style="width: 140px;">
          <p>有效期</p>
          <el-input v-model="basis.purchasecontract_expdate" size="mini" placeholder="Please Write"></el-input>
        </div>
        <div class="d2-m-10" style="min-width: 200px;">
          <p>交(提)货地点</p>
          <el-input v-model="basis.purchasecontract_transportation" size="mini" type="textarea"></el-input>
        </div>
        <div class="d2-m-10" style="min-width: 200px;">
          <p>签约地点</p>
          <el-input v-model="basis.purchasecontract_signed_address" size="mini" type="textarea"></el-input>
        </div>
      </div>
      <div class="item1">
        <div class="d2-m-10" style="width: 140px;">
          <p>质量标准</p>
          <el-input v-model="basis.p_quality_stardard" size="mini" placeholder="Please Write"></el-input>
        </div>
        <div class="d2-m-10" style="width: 140px;">
          <p>合理损耗</p>
          <el-input v-model="basis.p_reasonable_loss" size="mini" placeholder="Please Write"></el-input>
        </div>
        <div class="d2-m-10" style="width: 140px;">
          <p>验收标准</p>
          <el-input v-model="basis.p_accept_mode" size="mini" placeholder="Please Write"></el-input>
        </div>
        <div class="d2-m-10" style="min-width: 200px;">
          <p>包装标准&运输方式</p>
          <el-input v-model="basis.p_package_stardard" size="mini" placeholder="Please Write"></el-input>
        </div>
      </div>
      <div class="d2-mt-10">
        <el-button
    ...
    <!-- <el-card class="box-card deliver" style="width: 100%;">
        ...
        <table border="1" bordercolor="#E5E5E5">
            <tr class="td_pad">
                <td width='140'>快递公司</td>
                <td width='200'>快递账号</td>
                <td width='40'>状态</td>
                <td align='center' width='120'>
                    <el-button @click="add_deliver()" type="primary" size="mini">{{$t('add')}}</el-button>
                </td>
            </tr>
            <tr v-for="(item,index) in deliver_good">
                <td>
                    <el-select v-model="item.express_company_id" size="mini" clearable>
                    <el-option
                ...
                <td>
                    <el-input v-model="item.accounts" size="mini" clearable></el-input>
                </td>
                ...
                <td style="text-align:center;">
                    ...
                    <el-button @click="delete_deliver(item,index)" type="danger" size="mini" v-if="permissions.indexOf(500)>-1">{{$t('delete')}}</el-button>
                </td>
            </tr>
        </table>
    </el-card> -->
  ...
  data() {
    return {
      ...
      basis: {
        ...
        english_name: "",
        country_code: "",
        purchasecontract_expdate:'',
        purchasecontract_transportation:'',
        purchasecontract_signed_address:'',
        p_quality_stardard:'',
        p_reasonable_loss:'',
        p_accept_mode:'',
        p_package_stardard:'',
